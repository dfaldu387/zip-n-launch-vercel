-- Robert (video, 2026-09-14): the reservation lookup page should show WHEN a
-- stall/camp spot was assigned, not just which one. assignStallToBooking /
-- assignRvSpotToBooking (src/lib/stallAssignment.js, src/lib/rvAssignment.js)
-- now stamp stall.assignedAt / spot.assignedAt whenever a booking is placed.
-- get_public_booking just needs to pass that stamp through.
